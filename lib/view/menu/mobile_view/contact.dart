...
class MobileContactMenu extends StatelessWidget {
  const MobileContactMenu({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        padding: EdgeInsets.only(right: Sizes.defaultSpaceD, top: Sizes.spaceBtwSectionsM),
        child: Column(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      spacing: Sizes.defaultSpaceM,
                      children: [
                      Flexible(child: addressInfo(context, 'Location', bodyController.personalInfo.location??Texts.location)),
                      Spacer(),
                      Flexible(child: addressInfo(context, 'Phone', bodyController.contacts.phone??Texts.phone)),
                    ],
                    ),
